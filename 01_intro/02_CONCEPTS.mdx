Below is the updated markdown, with the quizzes replaced by the `<MultipleChoiceQuiz>` components:
...
<MultipleChoiceQuiz slug="transpilation-babel" correctAnswer={1}>
<Question> 
...
<MultipleChoiceQuiz slug="development-experience" correctAnswer={0}>
<Question> 
**Which of the following features does Bun provide for enhancing the development experience?**
</Question>

<Option>A. Hot Module Reloading (HMR)</Option>
<Option>B. Docker support out of the box</Option>
<Option>C. Cloud deployment tools</Option>
...
<Option>A. `bun start server.js`</Option>
<Option>B. `bun run server.js`</Option>
<Option>C. `bun server.js`</Option>
