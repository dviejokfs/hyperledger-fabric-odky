...
<MultipleChoiceQuiz slug="transpilation" correctAnswer={1}>
<Question> 
**Does Bun require Babel to transpile TypeScript code?**
</Question>

<Option>Yes</Option>
<Option>No, Bun supports transpiling TypeScript to JavaScript out of the box.</Option>
<Option>Only for advanced configurations</Option>

</MultipleChoiceQuiz>

<MultipleChoiceQuiz slug="hot-module-reload" correctAnswer={0}>
<Question> 
**Which of the following features does Bun provide for enhancing the development experience?**
</Question>

<Option>Hot Module Reloading (HMR)</Option>
<Option>Docker support out of the box</Option>
<Option>Cloud deployment tools</Option>

</MultipleChoiceQuiz>

#### Quiz 3: Usage and Commands

<MultipleChoiceQuiz slug="create-project" correctAnswer={2}>
<Question> 
**What is the command to create a new Bun project from a template?**
</Question>

<Option>{`bun new <template> <project-name>`}</Option>
<Option>{`bun init <template> <project-name>`}</Option>
<Option>{`bun create <template> <project-name>`}</Option>

</MultipleChoiceQuiz>

<MultipleChoiceQuiz slug="start-server" correctAnswer={2}>
<Question> 
**How do you start a HTTP server using Bun?**
</Question>

<Option>bun start server.js</Option>
<Option>bun run server.js</Option>
<Option>bun server.js</Option>
